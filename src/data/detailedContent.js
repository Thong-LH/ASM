// Nội dung thuyết minh chi tiết cho từng hiện vật trưng bày - Phòng 1: Thời Bao Cấp
const detailedContent = {
  obj_sogao: {
    title: "Cơ chế Quan liêu & Bao cấp",
    subtitle: "Phao cứu sinh thời bao cấp",
    imageUrl: "/assets/baocap.png",
    imageNote: "Sổ gạo và tem phiếu — Phao cứu sinh thời Bao cấp. Nguồn: Tư liệu lịch sử",
    images: [
      {
        paragraphIndex: 1,
        url: "/assets/baocap.png",
        note: "Sổ gạo và tem phiếu — Phao cứu sinh thời Bao cấp. Nguồn: Tư liệu lịch sử"
      }
    ],
    paragraphs: [
