// Nội dung thuyết minh chi tiết cho từng hiện vật - Phòng 3: Thành tựu Đổi mới
const detailedContent_room3 = {
  obj_cuonglinh: {
    ...
    paragraphs: [
      ...
      "Về kinh tế, Cương lĩnh khẳng định tiếp tục phát triển nền kinh tế hàng hóa nhiều thành phần vận hành theo cơ chế thị trường có sự quản lý của Nhà nước, giữ vững định hướng xã hội chủ nghĩa."
    ]
  },
  obj_bieudo: {
    ...
    paragraphs: [
      ...
      "Những thành tựu rực rỡ này chứng tỏ đường lối Đổi Mới là hoàn toàn đúng đắn, giúp nước ta chính thức thoát khỏi tình trạng khủng hoảng kinh tế - xã hội kéo dài."
    ]
  },
  obj_diacau: {
    ...
    paragraphs: [
      ...
      "Đây là tiền đề vô cùng quan trọng để nước ta tranh thủ nguồn lực bên ngoài, đẩy mạnh sự nghiệp Công nghiệp hóa - Hiện đại hóa đất nước."
    ]
  }
};

export default detailedContent_room3;
